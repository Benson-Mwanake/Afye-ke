...
export const AuthProvider = ({ children }) => {
  ...
  const refreshUser = async () => {
    ...
    try {
      const res = await fetch("https://afya-ke.onrender.com/auth/profile", {
  ...
  const login = async (emailOrObj, password, role) => {
    ...
    try {
      const res = await fetch("https://afya-ke.onrender.com/auth/login", {
        method: "POST",
  ...
  const signup = async (fullName, email, phoneNumber, password, role) => {
    try {
      const res = await fetch("https://afya-ke.onrender.com/auth/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          full_name: fullName,
