  ...
  return (
    <div className="min-h-screen bg-white pt-28 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center mb-12">
        ...
        <div className="mt-4 text-[#007BFF] text-sm font-medium transition-all duration-700">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <form className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#007BFF] focus:outline-none transition-all text-gray-700"
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-br from-[#007BFF] to-blue-600 text-white py-2.5 rounded-xl flex items-center justify-center gap-2 hover:opacity-90 transition-all"
            >
        ...
        {/* Contact Info */}
        <div className="flex flex-col justify-center bg-gradient-to-br from-[#007BFF]/5 to-blue-50 rounded-2xl border border-gray-100 shadow-sm p-8 space-y-6">
          <h2 className="text-lg font-semibold text-gray-800">Get in Touch</h2>

          <div className="flex items-start gap-3">
            <Mail className="w-5 h-5 text-[#007BFF] mt-1" />
            <div>
              <p className="text-gray-800 font-medium">Email</p>
              <p className="text-gray-600 text-sm">info@afyalink.co.ke</p>
            </div>
          </div>
